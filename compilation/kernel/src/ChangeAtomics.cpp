...
void changeAtomics(Module &M) {
    ...
    llvm::FunctionType *atomicFnTypeFloat =
        FunctionType::get(Float, FloatParams, false);

    std::vector<Type *> I64Params;
    I64Params.push_back(I64Ptr);
    I64Params.push_back(I64);
    llvm::FunctionType *atomicFnTypeI64 =
        FunctionType::get(I64, I64Params, false);

    std::vector<Type *> I32Params;
    I32Params.push_back(I32Ptr);
    I32Params.push_back(I32);
    llvm::FunctionType *atomicFnTypeI32 =
        FunctionType::get(I32, I32Params, false);
    ...
    llvm::FunctionType *atomicCASFnTypeI64 =
        FunctionType::get(I64, I64CasParams, false);
    ...
    llvm::FunctionType *atomicCASFnTypeI32 =
        FunctionType::get(I32, I32CasParams, false);
