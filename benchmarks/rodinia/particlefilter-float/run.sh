...
time ./particlefilter-float.cupbop -x 128 -y 128 -z 10 -np 1000 > output.cupbop.txt

echo "[*] Running HIPIFY version..."
time ./particlefilter-float.hipify -x 128 -y 128 -z 10 -np 1000 > output.hipify.txt
