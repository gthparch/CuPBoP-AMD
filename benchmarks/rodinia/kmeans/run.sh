...
# clang cluster.c getopt.c kmeans.c  kmeans_cuda.cu kmeans_clustering.c   rmse.c -c --cuda-path=/nethome/jchen706/cuda-11.5 -L/nethome/jchen706/cuda-11.5/lib64 -lcudart_static -ldl -lrt -pthread -save-temps -v
...
/nethome/jchen706/coding/code2/amdcuda/build/compilation/hostTranslator empty-host-x86_64-unknown-linux-gnu.ll empty.cpp-hip-amdgcn-amd-amdhsa.hipfb

llvm-dis empty-host-x86_64-unknown-linux-gnu.ll.translated_test.bc
# llvm-as  .ll
