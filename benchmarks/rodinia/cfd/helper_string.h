...
inline char *sdkFindFilePath(const char *filename,
    ...
    const char *searchPath[] = {
        ...
        "./data/",                       // "/data/" subdir
        "./src/",                        // "/src/" subdir
        "./src/<executable_name>/data/", // "/src/<executable_name>/data/"
                                         // subdir
        "./inc/",                        // "/inc/" subdir
        ...
        "../3_Imaging/<executable_name>/data/", // up 1 in tree,
                                                ...
                                                // subdir
        "../4_Financial/<executable_name>/data/", // up 1 in tree,
                                                  // "/4_Financial/<executable_name>/"
                                                  // subdir
        ...
        "../../3_Imaging/<executable_name>/data/", // up 2 in tree,
                                                   // "/3_Imaging/<executable_name>/"
                                                   // subdir
        "../../4_Financial/<executable_name>/data/", // up 2 in tree,
                                                     // "/4_Financial/<executable_name>/"
                                                     // subdir
        ...
        "../../../3_Imaging/<executable_name>/data/", // up 3 in tree,
                                                      // "/3_Imaging/<executable_name>/"
                                                      // subdir
        "../../../4_Financial/<executable_name>/data/", // up 3 in tree,
                                                        // "/4_Financial/<executable_name>/"
                                                        // subdir
        ...
        "../../../../3_Imaging/<executable_name>/data/", // up 4 in tree,
                                                         // "/3_Imaging/<executable_name>/"
                                                         // subdir
        "../../../../4_Financial/<executable_name>/data/", // up 4 in tree,
                                                           // "/4_Financial/<executable_name>/"
                                                           // subdir
        ...
        "../../../../../3_Imaging/<executable_name>/data/", // up 5 in tree,
                                                            // "/3_Imaging/<executable_name>/"
                                                            // subdir
        "../../../../../4_Financial/<executable_name>/data/", // up 5 in tree,
                                                              // "/4_Financial/<executable_name>/"
                                                              // subdir
