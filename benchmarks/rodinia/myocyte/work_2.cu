...
#include "kernel_fin_2.cuh"
#include "kernel_ecc_2.cuh"
#include "kernel_cam_2.cuh"
#include "kernel_2.cuh"
#include "embedded_fehlberg_7_8_2.cuh"
#include "solver_2.cuh"
...
int work_2(int xmax, int workload) {
    ...
    for (i = 0; i < workload; i++) {
        ...
        myocyte_read("../rodinia-data/myocyte/y.txt", &y[pointer], 91, 1, 0);
    }
    ...
    for (i = 0; i < workload; i++) {
        ...
        myocyte_read("../rodinia-data/myocyte/params.txt", &params[pointer], 18, 1, 0);
    }
    ...
    solver_2<<<blocks, threads>>>(workload, xmax,
                                  d_x, d_y, d_params,
                                  d_com, d_err, d_scale, d_yy, d_initvalu_temp,
                                  d_finavalu_temp);
